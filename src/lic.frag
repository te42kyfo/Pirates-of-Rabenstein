...
void main() {
    ...
    vec2 p1 = gl_TexCoord[0].st - vel.rg * t1 * 1.4;
    vec2 p2 = gl_TexCoord[0].st - vel.rg * t2 * 1.4;
    vec2 p3 = gl_TexCoord[0].st - vel.rg * t3 * 1.4;
    vec2 p4 = gl_TexCoord[0].st - vel.rg * t4 * 1.4;
